		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Adresler Arası Transfer",
									"targetURL": "#comerenaddresstransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerenaddresstransfer-display": {
								"semanticObject": "comerenaddresstransfer",
								"action": "display",
								"description": "Adresler Arası Transfer",
								"title": "Adresler Arası Transfer",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eren.addresstransfer",
									"url": sap.ui.require.toUrl("com/eren/addresstransfer")
								}
							}
						}
					}
